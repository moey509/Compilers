		...
		try {
			...
			case CLASSID:
				...
				case 1:
				 ...
				 ((TypeContext)_localctx).cub =  (((TypeContext)_localctx).t.cub==null) ? new CubexTypeClass((((TypeContext)_localctx).CLASSID!=null?((TypeContext)_localctx).CLASSID.getText():null), ((TypeContext)_localctx).t.cub) 
				                                                      : new CubexTypeClass((((TypeContext)_localctx).CLASSID!=null?((TypeContext)_localctx).CLASSID.getText():null), null);
				}
				break;
			case THING:
				{
	...
	public final TschemeContext tscheme() throws RecognitionException {
		...
		try {
			...
			if (_la==LANGLE) {
				...
				setState(110); ((TschemeContext)_localctx).k = ((TschemeContext)_localctx).kcont = kcont();
			...
			setState(119); ((TschemeContext)_localctx).type = type(0);
			    ...
			    ((TschemeContext)_localctx).cub =  (((TschemeContext)_localctx).k.cub==null) ? new CubexTypeScheme(null, ((TschemeContext)_localctx).tcont.cub, ((TschemeContext)_localctx).type.cub) 
		...
		try {
			...
			case 3:
				...
				setState(138); match(RPAREN);
				 ((ExprContext)_localctx).cub =  (((ExprContext)_localctx).tes.cub == null) ? new CubexFunctionCall((((ExprContext)_localctx).name!=null?((ExprContext)_localctx).name.getText():null), null, ((ExprContext)_localctx).pes.cub) 
				...
				if ( _alt==1 ) {
					...
					case 9:
						...
						setState(219); match(RPAREN);
						 ((ExprContext)_localctx).cub =  (((ExprContext)_localctx).tes.cub == null) ? new CubexFunctionApp(((ExprContext)_localctx).ex.cub, (((ExprContext)_localctx).VARFUN!=null?((ExprContext)_localctx).VARFUN.getText():null), null, ((ExprContext)_localctx).pes.cub)
						                                   : new CubexFunctionApp(((ExprContext)_localctx).ex.cub, (((ExprContext)_localctx).VARFUN!=null?((ExprContext)_localctx).VARFUN.getText():null), ((ExprContext)_localctx).tes.cub, ((ExprContext)_localctx).pes.cub); 
						}
						break;
	...
	public final StatementContext statement() throws RecognitionException {
		...
		try {
			...
			case CLASSID:
				...
				{
				setState(272); ((StatementContext)_localctx).c = match(CLASSID);
	...
	public final ProgramContext program() throws RecognitionException {
		...
		try {
			...
			case 4:
				...
				setState(399); ((ProgramContext)_localctx).p = program();
