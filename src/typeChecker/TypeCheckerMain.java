...
public class TypeCheckerMain {
	...
	public static void main(String[] args) throws IOException {
		...
		CharStream charStream = new ANTLRFileStream("semantics_tests/tc_test14.in");
...
//		System.out.println(c.functionContext);
	...
	static class ErrorListener implements ANTLRErrorListener {
		@Override
		public void reportAmbiguity(@NotNull Parser arg0, @NotNull DFA arg1, int arg2, int arg3, boolean arg4, @NotNull BitSet arg5, @NotNull ATNConfigSet arg6) {
		...
		@Override
		public void syntaxError(Recognizer<?, ?> arg0, @Nullable Object arg1, int arg2, int arg3, String arg4, @Nullable RecognitionException arg5) {
			// TODO Auto-generated method stub
			lexedWithError = true;
		}
	}
	...
	public void defineThing(ClassContext classContext, Map<String, CubexTypeClass> typeMap) { 
		// Define Thing
	...
	public void defineIterable(ClassContext classContext, Map<String, CubexTypeClass> typeMap) {

		// Define Iterable
		CubexList<CubexTypeGrammar> genericTypeList = new CubexList<CubexTypeGrammar>();
		genericTypeList.add(new CubexTypeName("E"));
		CubexTypeClass iterableType = new CubexTypeClass("Iterable", genericTypeList);
		typeMap.put("Iterable", iterableType);

		CubexList<String> iterableKindContext = new CubexList<String>();
		iterableKindContext.add("E");
		ClassContextElement iterableClassContextElement = new ClassContextElement(new CubexClassGrammar("Iterable", iterableKindContext,
				new CubexList<CubexTypeTuple>(), typeMap.get("Thing")));
		classContext.put("Iterable", iterableClassContextElement);
	}

	public void defineBoolean(ClassContext classContext, Map<String, CubexTypeClass> typeMap) {

		// Define Boolean
		CubexTypeClass booleanType = new CubexTypeClass("Boolean", new CubexList<CubexTypeGrammar>());
		typeMap.put("Boolean", booleanType);

		ClassContextElement booleanClassContextElement = new ClassContextElement(new CubexClassGrammar("Boolean", new CubexList<String>(),
				new CubexList<CubexTypeTuple>(), typeMap.get("Thing")));
		classContext.put("Boolean", booleanClassContextElement);

		// Define boolean iterable
		CubexTypeClass iterableBooleanType = new CubexTypeClass("Iterable", new CubexList<CubexTypeGrammar>());
		iterableBooleanType.getTypeList().add(booleanType);

		// Define negate
		booleanClassContextElement.functionMap.put("negate", new CubexTypeScheme(new CubexList<String>(),
		...
		booleanClassContextElement.functionMap.put("and", new CubexTypeScheme(new CubexList<String>(), andFunctionArguments, booleanType));
		...
		booleanClassContextElement.functionMap.put("or", new CubexTypeScheme(new CubexList<String>(), orFunctionArguments, booleanType));
		...
		booleanClassContextElement.functionMap.put("through", new CubexTypeScheme(new CubexList<String>(),
		...
		onwardFunctionArguments.add(new CubexTypeTuple("inclusive", booleanType));
		...
		booleanClassContextElement.functionMap.put("lessThan", new CubexTypeScheme(new CubexList<String>(),
		...
		booleanClassContextElement.functionMap.put("equals", new CubexTypeScheme(new CubexList<String>(),
				equalsFunctionArguments, booleanType));
	}

	public void defineInteger(ClassContext classContext, Map<String, CubexTypeClass> typeMap) {

		// Define Integer
		CubexTypeClass integerType = new CubexTypeClass("Integer", new CubexList<CubexTypeGrammar>());
		typeMap.put("Integer", integerType);

		ClassContextElement integerClassContextElement = new ClassContextElement(new CubexClassGrammar("Integer", new CubexList<String>(),
				new CubexList<CubexTypeTuple>(), typeMap.get("Thing")));
		...
		// Define negative
		integerClassContextElement.functionMap.put("negative", new CubexTypeScheme(new CubexList<String>(),
		...
		integerClassContextElement.functionMap.put("times", new CubexTypeScheme(new CubexList<String>(),
		...
		integerClassContextElement.functionMap.put("divide", new CubexTypeScheme(new CubexList<String>(),
		...
		integerClassContextElement.functionMap.put("modulo", new CubexTypeScheme(new CubexList<String>(),
		...
		integerClassContextElement.functionMap.put("minus", new CubexTypeScheme(new CubexList<String>(),
				minusFunctionArguments, integerType));

		// Define through
		CubexList<CubexTypeTuple> throughFunctionArguments = new CubexList<CubexTypeTuple>();
		throughFunctionArguments.add(new CubexTypeTuple("upper", integerType));
		throughFunctionArguments.add(new CubexTypeTuple("includeLower", typeMap.get("Boolean")));
		throughFunctionArguments.add(new CubexTypeTuple("includeUpper", typeMap.get("Boolean")));
		integerClassContextElement.functionMap.put("through", new CubexTypeScheme(new CubexList<String>(),
		...
		onwardFunctionArguments.add(new CubexTypeTuple("inclusive", typeMap
				.get("Boolean")));
		integerClassContextElement.functionMap.put("onward", new CubexTypeScheme(new CubexList<String>(),
				onwardFunctionArguments, iterableIntegerType));

		// Define lessThan
		CubexList<CubexTypeTuple> lessThanFunctionArguments = new CubexList<CubexTypeTuple>();
		lessThanFunctionArguments.add(new CubexTypeTuple("that", integerType));
		integerClassContextElement.functionMap.put("lessThan", new CubexTypeScheme(new CubexList<String>(),
				lessThanFunctionArguments, typeMap.get("Boolean")));

		// Define equals
		CubexList<CubexTypeTuple> equalsFunctionArguments = new CubexList<CubexTypeTuple>();
		equalsFunctionArguments.add(new CubexTypeTuple("that", integerType));
		integerClassContextElement.functionMap.put("equals", new CubexTypeScheme(new CubexList<String>(), equalsFunctionArguments, 
				typeMap.get("Boolean")));
	}

	public void defineCharacter(ClassContext classContext, Map<String, CubexTypeClass> typeMap) {
		...
		ClassContextElement characterClassContextElement = new ClassContextElement(new CubexClassGrammar("Character", new CubexList<String>(),
				new CubexList<CubexTypeTuple>(), typeMap.get("Thing")));
		classContext.put("Character", characterClassContextElement);

		// Define unicode
		characterClassContextElement.functionMap.put("unicode", new CubexTypeScheme(new CubexList<String>(), new CubexList<CubexTypeTuple>(), 
				typeMap.get("Integer")));

		// Define equals
		CubexList<CubexTypeTuple> equalsFunctionArguments = new CubexList<CubexTypeTuple>();
		equalsFunctionArguments.add(new CubexTypeTuple("that", characterType));
		characterClassContextElement.functionMap.put("equals", new CubexTypeScheme(new CubexList<String>(), equalsFunctionArguments, typeMap.get("Boolean")));
	}

	public void defineString(ClassContext classContext, Map<String, CubexTypeClass> typeMap) {

		// Define character iterable

		CubexTypeClass characterIterable = new CubexTypeClass("Iterable", new CubexList<CubexTypeGrammar>());
		characterIterable.getTypeList().add(new CubexTypeClass("Character",
				new CubexList<CubexTypeGrammar>()));
		...
		ClassContextElement stringClassContextElement = 
				new ClassContextElement(new CubexClassGrammar("String", new CubexList<String>(), new CubexList<CubexTypeTuple>(), characterIterable));
		classContext.put("String", stringClassContextElement);

		// Define equals
		CubexList<CubexTypeTuple> equalsFunctionArguments = new CubexList<CubexTypeTuple>();
		equalsFunctionArguments.add(new CubexTypeTuple("that", stringType));
		stringClassContextElement.functionMap.put("equals", new CubexTypeScheme(new CubexList<String>(), equalsFunctionArguments, typeMap.get("Boolean")));
	}

	public void defineFunctions(ClassContext classContext, FunctionContext functionContext, Map<String, CubexTypeClass> typeMap) {

		// Define character
		CubexList<CubexTypeTuple> characterFunctionArguments = new CubexList<CubexTypeTuple>();
		characterFunctionArguments.add(new CubexTypeTuple("unicode", typeMap.get("Integer")));
		functionContext.put("character", new CubexTypeScheme(new CubexList<String>(), characterFunctionArguments, typeMap.get("Character")));
		...
		functionContext.put("string", new CubexTypeScheme(new CubexList<String>(), stringFunctionArguments, typeMap.get("String")));
	}

	public void defineInput(TypeContext typeContext, Map<String, CubexTypeClass> typeMap) {
		CubexTypeClass stringIterable = new CubexTypeClass("Iterable", new CubexList<CubexTypeGrammar>());
